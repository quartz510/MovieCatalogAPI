...
import me.submission.app.moviecatalogapi.adapter.SearchMovieAdapter;
...
import me.submission.app.moviecatalogapi.viewmodel.SearchMovieViewModel;
...
public class SearchMovieFragment extends Fragment {
    ...
    private Observer<ArrayList<CataloguePojo>> getMovie = new Observer<ArrayList<CataloguePojo>>() {
        ...
        if(cataloguePojos!=null){
            adapter.setListMovie(cataloguePojos);
            loading(false);
        }
        }
    };
    ...
    private void callSearch(String s) {
        ...
        mViewModel = ViewModelProviders.of(this).get(SearchMovieViewModel.class);
        // TODO: Use the ViewModel
        mViewModel.getSearchTitle().observe(this, getMovie);
    ...
    private void addItemClickSupport() {
        ItemClickSupport.addTo(recyclerView).setOnItemClickListener(
            ...
            public void onItemClicked(RecyclerView recyclerView, int position, View v) {
                CataloguePojo pojo = SearchMovieAdapter.getMovie().get(position);
                String objectDesc = pojo.getDescMovie();
                String objectPhoto = pojo.getPhotoMovie();
                String objectTitle = pojo.getTitleMovie();
                int id = pojo.getId();
